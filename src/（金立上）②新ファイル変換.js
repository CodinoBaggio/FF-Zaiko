function convertNewFiles_kinryu_ue(newFiles, param) {
  ...
  const SHEEET_master =
    SpreadsheetApp.getActiveSpreadsheet().getSheetByName('金立上SAマスタ');
  ...
  var afterFolderID = sheet.getRange('I18').getValue();
  ...
  storeFilesIntoGCS_kinryu_ue(newFiles_converted);
}
